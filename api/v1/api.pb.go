...
var file_v1_api_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x31, 0x0a, 0x0b, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x07, 0x0a, 0x03, 0x4a, 0x50,
	0x47, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03,
	0x47, 0x49, 0x46, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x56, 0x47, 0x10, 0x03, 0x32, 0xc8,
	...
	0x04, 0x4d, 0x6f, 0x76, 0x65, 0x12, 0x0f, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f, 0x76, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f, 0x76, 0x65,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x50, 0x0a, 0x06, 0x63, 0x6f, 0x6d,
	0x2e, 0x76, 0x31, 0x42, 0x08, 0x41, 0x70, 0x69, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	0x14, 0x69, 0x74, 0x65, 0x6d, 0x2d, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x64, 0x2f, 0x61,
	0x70, 0x69, 0x2f, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x56, 0x58, 0x58, 0xaa, 0x02, 0x02, 0x56, 0x31,
...
var file_v1_api_proto_goTypes = []any{
	...
	(*ReadResponse_Children)(nil), // 10: v1.ReadResponse.Children
}
var file_v1_api_proto_depIdxs = []int32{
	...
	10, // 2: v1.ReadResponse.children:type_name -> v1.ReadResponse.Children
	1,  // 3: v1.CreateRequest.metadata:type_name -> v1.EntryMetadata
	2,  // 4: v1.ArchiveService.Read:input_type -> v1.ReadRequest
	4,  // 5: v1.ArchiveService.Create:input_type -> v1.CreateRequest
	6,  // 6: v1.ArchiveService.Move:input_type -> v1.MoveRequest
	8,  // 7: v1.ArchiveService.Delete:input_type -> v1.DeleteRequest
	3,  // 8: v1.ArchiveService.Read:output_type -> v1.ReadResponse
	5,  // 9: v1.ArchiveService.Create:output_type -> v1.CreateResponse
	7,  // 10: v1.ArchiveService.Move:output_type -> v1.MoveResponse
	9,  // 11: v1.ArchiveService.Delete:output_type -> v1.DeleteResponse
